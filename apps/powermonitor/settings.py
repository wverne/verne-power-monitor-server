...
# Generate a secret key if one does not exist. We can store this in the local
# filesystem because requests will never be split between multiple servers - we
# use a local DB (for now).
...
ROOT_URLCONF = 'apps.powermonitor.urls'
...
WSGI_APPLICATION = 'apps.powermonitor.wsgi.application'
